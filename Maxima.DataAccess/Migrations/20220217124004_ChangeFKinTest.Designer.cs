...
namespace Maxima.DataAccess.Migrations
{
    ...
    [Migration("20220217124004_ChangeFKinTest")]
    partial class ChangeFKinTest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Maxima.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Maxima.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Maxima.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("Maxima.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Maxima.Models.OrderHeader", b =>
                {
                    b.HasOne("Maxima.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Maxima.Models.Product", b =>
                {
                    b.HasOne("Maxima.Models.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Maxima.Models.Test", null)
                        .WithMany("Product")
                        .HasForeignKey("ProductId");
